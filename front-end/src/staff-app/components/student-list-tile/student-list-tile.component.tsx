...
export const StudentListTile: React.FC<Props> = ({ isRollMode, student, rollLister, currentState }) => {
  return (
    <S.Container>
      ...
      {isRollMode && (
        <S.Roll>
          <RollStateSwitcher rollLister={rollLister} currentState={currentState} personId={PersonHelper.getId(student)} />
        </S.Roll>
      )}
    </S.Container>
  )
